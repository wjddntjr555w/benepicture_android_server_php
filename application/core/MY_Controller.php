...
class MY_Controller extends CI_Controller
{
    ...
    protected $g_manager_label = 'bene_manager';
    /**
    ...
    protected function _file_upload($dir_path, $file_name, $should_redirect = true, $redirect_url = '', $file_type = 'jpg|jpeg|png|mp4|mov')
    {
        ...
        if ($this->upload->do_upload($file_name)) {
            return $dir_path . DIRECTORY_SEPARATOR . $this->upload->data('file_name');
        } else {
     ...
     * @return array
     */
    protected function _multi_file_upload($dir_path, $file_name, $should_redirect = true, $redirect_url = '', $file_type = 'jpg|jpeg|png|mp4|mov')
    {
        $files = [];
    ...
    protected function _show_res_msg($res_msg = '', $res_class = 'success', $res_title = '알림')
    {
    ...
    public function _send_push($device, $tokens, $data)
    {
        ...
        $api_key = "AAAABHr6q4U:APA91bGEx33MAT65rU8_u505c3UXs6yOzqki9-JdS5o_SIiTaZJCRVOXhkCc9TUriXm_54Lay7ve1YG-0CtVP75vW0oBf_tss5-pcNhL_iyH9gMtzF4tKm_96Xwtg6-wnJaWFJqK4Iso";
